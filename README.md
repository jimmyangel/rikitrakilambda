...
| `/usermotd/{username}` | GET | Returns the five most recent tracks with pictures for a given user. If the user name is ommitted then it is equivalent to /motd (global).| 200&nbsp;Success<br>500&nbsp;Server&nbsp;error | `getUserMotd` |
